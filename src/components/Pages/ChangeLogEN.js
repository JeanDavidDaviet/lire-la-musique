...
const ChangeLogEN = () => (
  <article className="page">
    ...
    <ul className="changelogs">
      ...
      <li>
        <strong>1.1</strong> – 08/17/2018
        <ul>
          <li>Added React Router for navigation between pages</li>
        </ul>
      </li>
      <li>
        <strong>1.0</strong> – 08/16/2018
        <ul>

import { RUNNING, INCREMENT_TEMPO, DECREMENT_TEMPO, INCREMENT_SCALE, DECREMENT_SCALE, SET_SCALE, SET_TEMPO, SET_CLEF, SET_TIME, SET_INSTRUMENT } from "../actions/actionTypes";
